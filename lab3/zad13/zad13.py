...
if __name__ == "__main__":
    data = [0xed, 0x74, 0x0b, 0x55, 0x00, 0x24, 0xef, 0xfd, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x6d, 0x69, 0x6e,
            0x67, 0x20, 0x69, 0x6e, 0x20, 0x70, 0x79, 0x74, 0x68, 0x6f, 0x6e, 0x20, 0x69, 0x73, 0x20, 0x66, 0x75, 0x6e]

    src_port, dst_port, data_str = parse_udp(data)

    msg = (f"zad13odp;src;{src_port};\n"
           f"dst;{dst_port};\n"
           f"data;{data_str}")
    print(msg)
